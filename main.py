...
def realtime():
    ...
    classes=["Corona","OK","Peace","Punch","Stop","Thumbs_down"]
    ...
    while rval:
        ...
        histarray2={'PEACE': y_pred[0][0], 'PUNCH': y_pred[0][1], 'STOP': y_pred[0][2], 'Thumbs DOWN': y_pred[0][3],'OK': y_pred[0][4],'CORONA': y_pred[0][5]} #this
        update(histarray2)
